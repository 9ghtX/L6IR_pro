///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.70.1.11437/W32 for ARM      18/Apr/2019  18:40:21
...
//    Command line =  
//        E:\projects\L6IR\programm\L6_pro\led_control.c -D
...
//    List file    =  
//        E:\projects\L6IR\programm\L6_pro\Release\List\led_control.s
//
///////////////////////////////////////////////////////////////////////////////
...
led_pulse_control:
        PUSH     {R7,LR}
        MOVS     R1,#+32
        LDR.N    R0,??DataTable1  ;; 0x40020400
        BL       GPIO_ResetBits
        POP      {R0,PC}          ;; return
