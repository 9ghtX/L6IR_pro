...
/**
  ...
  * @retval None
  */
void RFU_FLASH_SetLatency(uint32_t FLASH_Latency)
{
   uint32_t tmpreg = 0;
...
/**
  ...
  * @retval None
  */
void RFU_FLASH_PrefetchBufferCmd(FunctionalState NewState)
{
  /* Check the parameters */
...
/**
  ...
  * @retval None
  */
void RFU_FLASH_ReadAccess64Cmd(FunctionalState NewState)
{
  /* Check the parameters */
  assert_param(IS_FUNCTIONAL_STATE(NewState));
...
/**
  ...
  * @retval None
  */
void RFU_FLASH_SLEEPPowerDownCmd(FunctionalState NewState)
{
  /* Check the parameters */
  assert_param(IS_FUNCTIONAL_STATE(NewState));
...
void RFU_FLASH_Unlock(void)
{
  ...
  RFU_FLASH_ClearFlag(FLASH_FLAG_EOP | FLASH_FLAG_PGAERR | FLASH_FLAG_WRPERR);	
}
...
/**
  ...
  */
FLASH_Status RFU_FLASH_ErasePage(uint32_t Page_Address)
{
  ...
  status = RFU_FLASH_WaitForLastOperation(FLASH_ER_PRG_TIMEOUT);
...
FLASH_Status RFU_FLASH_EraseAllPages(void) 
{
...
/******* Devices with FLASH 256K *******/
  ...
  const uint32_t flash_begin = 0x08000000;
  const uint32_t flash_end   = 0x0803FFFF; //256k
  const uint32_t pg_size     = 256UL;

  for( uint32_t page = flash_begin; page < flash_end; page+= pg_size)
  {
   status |= RFU_FLASH_ErasePage(page);
  }
#else 
#error "How many pages in yours STM32L? Maybe use parrallel Flash erase?"
#endif
...
/**
  ...
  *   FLASH_ERROR_PROGRAM, FLASH_ERROR_WRP, FLASH_COMPLETE or FLASH_TIMEOUT.
  */
FLASH_Status RFU_FLASH_FastProgramWord(uint32_t Address, uint32_t Data)
{
  FLASH_Status status = FLASH_COMPLETE;
...
/**
  ...
  * @retval None
  */
void RFU_DATA_EEPROM_Unlock(void)
{
...
/**
  ...
  * @retval None
  */
void RFU_DATA_EEPROM_Lock(void)
{
...
/**
  ...
  * @retval None
  */
void RFU_DATA_EEPROM_FixedTimeProgramCmd(FunctionalState NewState)
{
  /* Check the parameters */
  assert_param(IS_FUNCTIONAL_STATE(NewState));
...
/**
  ...
  *   FLASH_ERROR_PROGRAM, FLASH_ERROR_WRP, FLASH_COMPLETE or FLASH_TIMEOUT.
  */
FLASH_Status RFU_DATA_EEPROM_EraseByte(uint32_t Address)
{
  FLASH_Status status = FLASH_COMPLETE;
...
/**
  ...
  *   FLASH_ERROR_PROGRAM, FLASH_ERROR_WRP, FLASH_COMPLETE or FLASH_TIMEOUT.
  */
FLASH_Status RFU_DATA_EEPROM_EraseHalfWord(uint32_t Address)
{
  FLASH_Status status = FLASH_COMPLETE;
...
/**
  ...
  *   FLASH_ERROR_PROGRAM, FLASH_ERROR_WRP, FLASH_COMPLETE or FLASH_TIMEOUT.
  */
FLASH_Status RFU_DATA_EEPROM_EraseWord(uint32_t Address)
{
  FLASH_Status status = FLASH_COMPLETE;
...
/**
  ...
  *         FLASH_ERROR_PROGRAM, FLASH_ERROR_WRP, FLASH_COMPLETE or FLASH_TIMEOUT.
  */
FLASH_Status RFU_DATA_EEPROM_FastProgramByte(uint32_t Address, uint8_t Data)
{
  FLASH_Status status = FLASH_COMPLETE;
  ...
  if(status == FLASH_COMPLETE)
  {
    ...
    else
    {
      ...
      tmp &= ~tmpaddr;
      status = RFU_DATA_EEPROM_EraseWord(Address & 0xFFFFFFFC);
      status = RFU_DATA_EEPROM_FastProgramWord((Address & 0xFFFFFFFC), tmp);
    }
...
/**
  ...
  *         FLASH_ERROR_PROGRAM, FLASH_ERROR_WRP, FLASH_COMPLETE or  FLASH_TIMEOUT.
  */
FLASH_Status RFU_DATA_EEPROM_FastProgramHalfWord(uint32_t Address, uint16_t Data)
{
  FLASH_Status status = FLASH_COMPLETE;
#if !defined (STM32L1XX_HD) && !defined (STM32L1XX_MDP) && !defined (STM32L1XX_XL)
  uint32_t tmp = 0, tmpaddr = 0;
  ...
  if(status == FLASH_COMPLETE)
  {
    ...
    else
    {
      ...
      {
        RFU_DATA_EEPROM_FastProgramByte(Address, 0x00);
        RFU_DATA_EEPROM_FastProgramByte(Address + 1, 0x00);
      }
    }
#elif defined (STM32L1XX_HD) || defined (STM32L1XX_MDP) || defined (STM32L1XX_XL)
    /* If the previous operation is completed, proceed to write the new data */
...
/**
  ...
  *         FLASH_ERROR_PROGRAM, FLASH_ERROR_WRP, FLASH_COMPLETE or FLASH_TIMEOUT.
  */
FLASH_Status RFU_DATA_EEPROM_FastProgramWord(uint32_t Address, uint32_t Data)
{
  FLASH_Status status = FLASH_COMPLETE;
...
/**
  ...
  *   FLASH_ERROR_PROGRAM, FLASH_ERROR_WRP, FLASH_COMPLETE or FLASH_TIMEOUT.
  */
FLASH_Status RFU_DATA_EEPROM_ProgramByte(uint32_t Address, uint8_t Data)
{
  FLASH_Status status = FLASH_COMPLETE;
#if !defined (STM32L1XX_HD) && !defined (STM32L1XX_MDP) && !defined (STM32L1XX_XL)
  uint32_t tmp = 0, tmpaddr = 0;
...
/**
  ...
  *   FLASH_ERROR_PROGRAM, FLASH_ERROR_WRP, FLASH_COMPLETE or FLASH_TIMEOUT.
  */
FLASH_Status RFU_DATA_EEPROM_ProgramHalfWord(uint32_t Address, uint16_t Data)
{
  FLASH_Status status = FLASH_COMPLETE;
#if !defined (STM32L1XX_HD) && !defined (STM32L1XX_MDP) && !defined (STM32L1XX_XL)
  uint32_t tmp = 0, tmpaddr = 0;
...
/**
  ...
  *   FLASH_ERROR_PROGRAM, FLASH_ERROR_WRP, FLASH_COMPLETE or  FLASH_TIMEOUT.
  */
FLASH_Status RFU_DATA_EEPROM_ProgramWord(uint32_t Address, uint32_t Data)
{
  FLASH_Status status = FLASH_COMPLETE;
...
/**
  ...
  *         FLASH_ERROR_PROGRAM, FLASH_ERROR_WRP, FLASH_COMPLETE or FLASH_TIMEOUT.
  */
FLASH_Status RFU_FLASH_OB_WRPConfig(uint32_t OB_WRP, FunctionalState NewState)
{
...
/**
  ...
  *         FLASH_ERROR_PROGRAM, FLASH_ERROR_WRP, FLASH_COMPLETE or FLASH_TIMEOUT.
  */
FLASH_Status RFU_FLASH_OB_WRP1Config(uint32_t OB_WRP1, FunctionalState NewState)
{
...
/**
  ...
  *         FLASH_ERROR_PROGRAM, FLASH_ERROR_WRP, FLASH_COMPLETE or FLASH_TIMEOUT.
  */
FLASH_Status RFU_FLASH_OB_WRP2Config(uint32_t OB_WRP2, FunctionalState NewState)
{
...
/**
  ...
  *         FLASH_ERROR_PROGRAM, FLASH_ERROR_WRP, FLASH_COMPLETE or FLASH_TIMEOUT.
  */
FLASH_Status RFU_FLASH_OB_RDPConfig(uint8_t OB_RDP)
{
  FLASH_Status status = FLASH_COMPLETE;
  uint8_t tmp1 = 0;
  uint32_t tmp2 = 0;
...
/**
  ...
  *         FLASH_ERROR_PROGRAM, FLASH_ERROR_WRP, FLASH_COMPLETE or FLASH_TIMEOUT.
  */
FLASH_Status RFU_FLASH_OB_PCROPConfig(uint32_t OB_WRP, FunctionalState NewState)
{
  uint32_t WRP01_Data = 0, WRP23_Data = 0;
...
/**
  ...
  *         FLASH_ERROR_PROGRAM, FLASH_ERROR_WRP, FLASH_COMPLETE or FLASH_TIMEOUT.
  */
FLASH_Status RFU_FLASH_OB_PCROP1Config(uint32_t OB_WRP1, FunctionalState NewState)
{
  uint32_t WRP45_Data = 0, WRP67_Data = 0;
...
/**
  ...
  *         FLASH_ERROR_PROGRAM, FLASH_ERROR_WRP, FLASH_COMPLETE or FLASH_TIMEOUT.
  */
FLASH_Status RFU_FLASH_OB_PCROPSelectionConfig(uint16_t OB_PcROP)
{
  FLASH_Status status = FLASH_COMPLETE;
  uint16_t tmp1 = 0;
  uint32_t tmp2 = 0;
...
/**
  ...
  *         FLASH_ERROR_PROGRAM, FLASH_ERROR_WRP, FLASH_COMPLETE or FLASH_TIMEOUT.
  */
FLASH_Status RFU_FLASH_OB_UserConfig(uint8_t OB_IWDG, uint8_t OB_STOP, uint8_t OB_STDBY)
{
  FLASH_Status status = FLASH_COMPLETE;
...
/**
  ...
  * FLASH_ERROR_PROGRAM, FLASH_ERROR_WRP, FLASH_COMPLETE or FLASH_TIMEOUT.
  */
FLASH_Status RFU_FLASH_OB_BORConfig(uint8_t OB_BOR)
{
  FLASH_Status status = FLASH_COMPLETE;
  uint32_t tmp = 0, tmp1 = 0;
...
/**
  ...
  *         FLASH_ERROR_PROGRAM, FLASH_ERROR_WRP, FLASH_COMPLETE or FLASH_TIMEOUT.
  */
FLASH_Status RFU_FLASH_OB_BootConfig(uint8_t OB_BOOT)
{
  FLASH_Status status = FLASH_COMPLETE;
  uint32_t tmp = 0, tmp1 = 0;
...
/**
  ...
  */
uint8_t RFU_FLASH_OB_GetUser(void)
{
...
/**
  ...
  */
uint32_t RFU_FLASH_OB_GetWRP(void)
{
...
/**
  ...
  * @retval The FLASH Write Protection Option Bytes value.
  */
uint32_t RFU_FLASH_OB_GetWRP1(void)
{
  /* Return the FLASH write protection Register value */
...
/**
  ...
  * @retval The FLASH Write Protection Option Bytes value.
  */
uint32_t RFU_FLASH_OB_GetWRP2(void)
{
  /* Return the FLASH write protection Register value */
...
/**
  ...
  */
FlagStatus RFU_FLASH_OB_GetRDP(void)
{
...
/**
  ...
  */
FlagStatus RFU_FLASH_OB_GetSPRMOD(void)
{
  FlagStatus readstatus = RESET;
  uint16_t tmp = 0;
...
/**
  ...
  * @retval The FLASH User Option Bytes.
  */
uint8_t RFU_FLASH_OB_GetBOR(void)
{
...
/**
  ...
  * @retval None
  */
void RFU_FLASH_ITConfig(uint32_t FLASH_IT, FunctionalState NewState)
{
  /* Check the parameters */
...
/**
  ...
  */
FlagStatus RFU_FLASH_GetFlagStatus(uint32_t FLASH_FLAG)
{
...
/**
  ...
  * @retval None
  */
void RFU_FLASH_ClearFlag(uint32_t FLASH_FLAG)
{
  /* Check the parameters */
...
/**
  ...
  */
FLASH_Status RFU_FLASH_GetStatus(void)
{
...
/**
  ...
  *   FLASH_ERROR_PROGRAM, FLASH_ERROR_WRP, FLASH_COMPLETE or FLASH_TIMEOUT.
  */
FLASH_Status RFU_FLASH_WaitForLastOperation(uint32_t Timeout)
{
  __IO FLASH_Status status = FLASH_COMPLETE;

  /* Check for the FLASH Status */
  status = RFU_FLASH_GetStatus();
