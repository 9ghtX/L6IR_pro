/**
  ...
  *        APB2 Prescaler               | 1
  *-----------------------------------------------------------------------------
  *        HSE Frequency                | 14745600 Hz 11059200
  *-----------------------------------------------------------------------------
  *        PLL DIV                      | 1
  *-----------------------------------------------------------------------------
  *        PLL MUL                      | 1
...
#ifdef FR14745600
       uint32_t SystemCoreClock = 14745600;  // 4000000;
#elif  FR11059200
       uint32_t SystemCoreClock = 11059200;  // 4000000;
#endif
...
void SystemInit (void)
{
  ...
  RCC->CR &= (uint32_t)0xEEFEFFFE;
    ...
    /*!< Set HSEON, PLLON bits */
//  RCC->CR |= (uint32_t)0x01010000;
...
void SetSysClockToHSI(void)
{
  ...
  if (HSIStatus == (uint32_t)0x01)
  {
    ...
    /* PCLK2 = HCLK */
    RCC->CFGR |= (uint32_t)RCC_CFGR_HPRE_DIV1; // 8Mhz APB2
