     ...
     for(i=0;i<keys_q;i++)
        {
          ...
          switch(code)
          {
           case ENCODER_PLUS_0:
                 ...
                 push(&keys.keys_stack, KEY_DISTANTS_PLUS);
           break;

           case ENCODER_MINUS_0:
                 senspar.change_par = true;
                 push(&keys.keys_stack, KEY_DISTANTS_MINUS);
           break;
  ...
  switch(code)
    {
           case ENCODER_PLUS_0:
              //senspar.change_par = true;
                 push(&keys.keys_stack, KEY_EOC_BRIGHTNES_PLUS);

           break;

           case ENCODER_MINUS_0:
              //senspar.change_par = true;
                 push(&keys.keys_stack, KEY_EOC_BRIGHTNES_MINUS);
